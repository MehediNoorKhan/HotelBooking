...
const ProductCard: React.FC<ProductCardProps> = ({ properties }) => {
  ...
  return (
    <div className="relative bg-[#161616]  py-[30px] sm:px-[20px] sm:py-[40px] md:px-[40px]">
      ...
      <div className="relative flex items-center">
        ...
        {/* Cards */}
        <div className="flex gap-[20px] sm:gap-[24px] md:gap-[28px] lg:gap-[32px] xl:gap-[40px] overflow-hidden w-full">
            ...
            >
              ...
              <div className="relative w-full" style={{ height: "200px" }}>
                <img
                  ...
                  alt={item.title}
                />
                <div className="absolute top-[10px] right-[10px] bg-white px-[8px] py-[6px] rounded-full text-[14px] sm:top-[12px] sm:right-[12px] sm:text-[15px] md:text-[16px] xl:top-3 xl:right-3 xl:px-[9px] xl:py-[9px] xl:text-[16px]">
              ...
              <div className="px-[14px] pt-[12px] pb-[18px] sm:px-[16px] md:px-[18px] xl:px-[16px] xl:pt-[12px] xl:pb-[20px]">
                ...
                {/* Button */}
                <button className="mt-[14px] w-full border border-[#EBE0CA] text-black py-[10px] rounded-xl text-[14px] sm:text-[15px] md:text-[16px] font-medium transition hover:bg-[#D4BB8C] hover:text-white xl:py-[8px] xl:px-[137px] cursor-pointer">
                  See details...
                </button>
              </div>
            </div>
