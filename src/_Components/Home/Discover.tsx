...
export default function Discover() {
  return (
    ...
    "
          style={{
            background:
              "linear-gradient(90deg, rgba(0,0,0,0.35) 0.01%, rgba(102,102,102,0) 99.99%)",
          }}
        >
          <p className="text-sm md:text-base leading-relaxed">
            ...
            favorite meals. Enjoy the convenience of in-unit laundry and a
            private balcony for relaxing evenings. Located in a vibrant
            neighborhood, you'll have easy access to shops, restaurants, and
            parks. Make this charming apartment your new home!
          </p>
        </div>
