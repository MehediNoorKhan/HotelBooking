    ...
    >
      ...
      <div className="max-w-7xl mx-auto text-center space-y-3">
        ...
        <div
          className="
                        mx-auto rounded-3xl
                        bg-muted-foreground/50 backdrop-blur-[15.3px]
        ...
        >
          <h3
            className="
                            text-muted text-start font-bold 
                            text-lg md:text-xl          /* responsive */
                            xl:text-[20px]  mb-2  md:mb-3 xl:mb-5
                        "
          >
            Book your apartment
          </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div
              className="
                                flex items-center gap-2 border border-border/50 text-white/35 
            ...
            >
              ...
              <span className="flex-1 text-muted text-sm md:text-base lg:text-lg xl:text-[18px]">
                Location
              </span>
            </div>
            ...
            <button
              className="
                                bg-primary/90 text-muted font-bold 
                                py-3 md:py-4 lg:py-5
                                rounded-xl cursor-pointer
                                text-base md:text-lg lg:text-xl
                                xl:text-[20px] xl:px-[87px] xl:py-[26px]
                            "
            >
              Search
            </button>
